...
pub fn init(env: &mut Env) {
    ...
    env.set(COLOR_BUTTON, Color::rgba8(0x35, 0xff, 0x00, 0x35));
    env.set(COLOR_BUTTON_PRIMARY, Color::rgba8(0x35, 0xff, 0x35, 0x1f));
    env.set(COLOR_BUTTON_HOT, Color::rgba8(0x35, 0xff, 0x35, 0x3f));
    env.set(COLOR_BUTTON_ACTIVE, Color::rgba8(0x35, 0xff, 0x35, 0x1f));
    env.set(COLOR_BUTTON_DISABLED, Color::rgba8(0x35, 0xff, 0x35, 0x1f));
    env.set(COLOR_BUTTON_BORDER, Color::rgba8(0x00, 0x00,0x35, 0x3f));
    env.set(COLOR_BUTTON_BORDER_HOT, Color::rgba8(0x35, 0xff, 0x35, 0xff));
    env.set(COLOR_BUTTON_BORDER_ACTIVE, Color::rgba8(0x35, 0xff, 0x35, 0x7f));
